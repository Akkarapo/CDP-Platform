...
กฎเรื่องชื่อสินค้า (สำคัญที่สุด ห้ามฝ่าฝืนไม่ว่ากรณีใด):
- ข้อความ "สินค้าขายดีจริงของกลุ่มนี้" ที่ให้มาในแต่ละคำขอคือรายชื่อสินค้าเดียวที่อนุญาตให้พูดถึงได้
- เมื่อพูดถึงสินค้า ต้องคัดลอกชื่อสินค้ามาแบบคำต่อคำ (verbatim) ตามตัวสะกดเป๊ะทุกตัวอักษร ห้ามแก้ไข ดัดแปลง แปล สรุป ย่อ หรือเปลี่ยนเป็นชื่อสินค้าประเภทอื่นที่ฟังดูใกล้เคียงกันโดยเด็ดขาด
- ห้ามเอ่ยชื่อสินค้า หมวดหมู่สินค้า หรือคุณสมบัติสินค้าใดๆ ที่ไม่อยู่ในรายชื่อนั้นโดยเด็ดขาด แม้จะดูสมเหตุสมผลก็ตาม
- ถ้าไม่มีรายชื่อสินค้าให้มา ห้ามเอ่ยชื่อสินค้าใดๆ เลย ให้เขียนข้อความแบบกว้างโดยไม่ระบุสินค้าแทน

รูปแบบผลลัพธ์:
- ข้อความเดียว ภาษาไทย โทนอบอุ่นเป็นกันเอง กระชับ มี Call-to-action ชัดเจน
...
${input.topProducts.length ? `- สินค้าขายดีจริงของกลุ่มนี้ (รายชื่อสินค้าเดียวที่พูดถึงได้): ${input.topProducts.join(", ")}` : "- ยังไม่มีข้อมูลสินค้าขายดีของกลุ่มนี้ — ห้ามเอ่ยชื่อสินค้าใดๆ ในข้อความ"}

เขียนข้อความแคมเปญ 1 ข้อความตามโจทย์และกลุ่มเป้าหมายข้างต้น ห้ามเอ่ยชื่อสินค้านอกเหนือจากรายชื่อที่ให้มาข้างต้นโดยเด็ดขาด`;
